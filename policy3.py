...
def if_unhappy(key, latest_grid, score, k,rows,columns):
    if grid_dict[key]['value']==1:
        for empty_key in empty_list_key:
            if 5 < grid_dict[empty_key]['position'][-1][0] < 35 and 8 < grid_dict[empty_key]['position'][-1][1] < 34:
...
iterations=50
k= 4
initial_plot='First_Prachi'
final_plot='Final_Prachi'
graph_plot='graph_Prachi'
