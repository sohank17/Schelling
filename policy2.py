...
def if_unhappy(key, latest_grid, score, k,rows,columns,m):
    ...
    friend_list(key,latest_grid, score, k, m)
...
def friend_list(agent_key,latest_grid, score, k,m):
...
friends=5
neighbour_matrix=3
initial_plot='First_Policy2'
final_plot='Final_Policy2'
graph_plot='graph_Policy2'
